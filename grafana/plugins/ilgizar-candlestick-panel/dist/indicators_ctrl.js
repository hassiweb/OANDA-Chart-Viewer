...
System.register(['lodash', 'angular'], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      _export('IndicatorsCtrl', IndicatorsCtrl =
      /** @ngInject */
      function IndicatorsCtrl($scope, $element, popoverSrv) {
        _classCallCheck(this, IndicatorsCtrl);
...
//# sourceMappingURL=indicators_ctrl.js.map
